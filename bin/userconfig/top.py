...
class gap(Comp):
    ...
    def gen(self):
        ...
        result['gap']['includes'] = ['configs/gap.json']
        return result
...
class wolfe(Comp):
    ...
    def gen(self):
        ...
        result['wolfe']['includes'] = ['configs/wolfe.json']
        return result
...
class vivosoc3(Comp):
    ...
    def gen(self):
        ...
        result['vivosoc3']['includes'] = ['configs/vivosoc3.json']
        return result
...
class quentin(Comp):
    ...
    def gen(self):
        ...
        result['quentin']['includes'] = ['configs/quentin.json']
        return result
...
class pulpissimo(Comp):
    ...
    def gen(self):
        ...
        result['pulpissimo']['includes'] = ['configs/pulpissimo.json']
        return result
...
class pulpino(Comp):
    ...
    def gen(self):
        ...
        result['pulpino']['includes'] = ['configs/pulpino.json']
        return result
...
class hyperram(Comp):
    ...
    def gen(self):
        ...
        result['includes'] = ['configs/periphs/hyperflash.json']
...
class spiflash(Comp):
    ...
    def gen(self):
        ...
        result['includes'] = ['configs/periphs/spiflash.json']
        result['size'] = "0x00800000"
        return result
...
class microphone(Comp):
    ...
    def gen(self):
        ...
        result['includes'] = ['configs/periphs/microphone.json']
        return result
...
class himax(Comp):
    ...
    def gen(self):
        ...
        result['includes'] = ['configs/periphs/himax.json']
        return result
...
class ov7670(Comp):
    ...
    def gen(self):
        ...
        result['includes'] = ['configs/periphs/ov7670.json']
        return result
